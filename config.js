...
const EncryptedDatabase = {
	...
	s5: EncryptData('> 🌸 *MISS SHASIKALA* [BOT]✨ | 👑 _CREATED BY_ *NIMESHA MADHUSHAN* '),
	...
	h5: crypto.createHash('sha256').update(EncryptData('> 🌸 *MISS SHASIKALA* [BOT]✨ | 👑 _CREATED BY_ *NIMESHA MADHUSHAN* ')).digest('hex'),
